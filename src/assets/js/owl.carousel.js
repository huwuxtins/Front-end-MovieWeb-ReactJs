 ...
 */
	...
	; (function ($, window, document, undefined) {
		...
		/**
		 * The window.jQuery Plugin for the Owl Carousel
		...
		/**
		 * The constructor for the window.jQuery Plugin
		 * @public
		 */
	...
	; (function ($, window, document, undefined) {
		...
		var AutoHeight = function (carousel) {
			...
			// and have been made compatible with the latest window.jQuery version
